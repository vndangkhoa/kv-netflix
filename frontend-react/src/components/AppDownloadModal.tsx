    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fade-in">
            <div className="relative w-full max-w-2xl bg-[#12121A] border border-white/10 rounded-2xl p-6 shadow-2xl shadow-black/80 overflow-hidden text-white">
                ...
                <div className="absolute -top-24 -right-24 w-60 h-60 bg-[var(--accent)]/10 rounded-full blur-3xl pointer-events-none" />
                <div className="absolute -bottom-24 -left-24 w-60 h-60 bg-[var(--accent)]/10 rounded-full blur-3xl pointer-events-none" />
                ...
                <button
                    ...
                    tabIndex={0}
                    aria-label="Close"
                    className="absolute top-5 right-5 p-2 text-gray-400 hover:text-white hover:bg-white/10 focus:bg-white/20 focus:outline-none focus:ring-2 focus:ring-[var(--accent)] rounded-full transition-all"
                >
                    <X size={22} />
                </button>
                ...
                <div className="flex items-center gap-3.5 mb-6">
                    <div className="p-3 bg-[var(--accent)]/15 text-[var(--accent)] rounded-xl border border-[var(--accent)]/30">
                        <Download size={26} />
                    </div>
                    <div>
                        <h2 className="text-xl font-extrabold tracking-tight text-white">Tải ứng dụng kv-netflix</h2>
                        <div className="flex items-center gap-2 mt-1">
                            <span className="text-xs font-semibold px-2.5 py-0.5 bg-[var(--accent)]/15 text-[var(--accent)] border border-[var(--accent)]/30 rounded-full">
                                v{downloads.version}
                            </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    {/* Android TV Card */}
                    <div className="flex flex-col justify-between p-5 bg-[#1A1A26] border border-white/10 rounded-xl hover:border-[var(--accent)]/50 transition-all shadow-lg">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="p-2.5 bg-[var(--accent)]/15 text-[var(--accent)] rounded-xl border border-[var(--accent)]/30">
                                <Tv size={24} />
                            </div>
                            <div>
                                <h3 className="font-bold text-white text-base">Ứng dụng Android TV</h3>
                                <span className="inline-block text-[11px] font-semibold px-2.5 py-0.5 bg-[var(--accent)]/15 text-[var(--accent)] rounded-full mt-0.5">
                        ...
                        <div className="space-y-2.5">
                            <a
                                ...
                                rel="noreferrer"
                                tabIndex={0}
                                className="flex items-center justify-between w-full px-4 py-2.5 bg-[var(--accent)] hover:bg-[var(--accent-hover)] focus:outline-none focus:ring-2 focus:ring-white focus:scale-[1.03] text-[var(--accent-contrast)] rounded-xl font-semibold text-xs transition-all shadow-md active:scale-95"
                            >
